...
const corePhases: LearningPhase[] = [
  {
    ...
    description: "Follow one request from program state through the network to a dependable integration.",
    topics: ["Program State", "Processes & Ports", "HTTP Messages", "Contracts & Retries"],
