      ...
      <div className="container mx-auto px-6 py-16 max-w-3xl">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="text-gray-300 list-disc pl-5 space-y-1">
              <li><strong>Stripe:</strong> payment processing (see <a href="https://stripe.com/privacy" className="text-violet-400 hover:text-violet-300">Stripe Privacy Policy</a>)</li>
              <li><strong>Vercel:</strong> hosting and analytics (see <a href="https://vercel.com/legal/privacy-policy" className="text-violet-400 hover:text-violet-300">Vercel Privacy Policy</a>)</li>
