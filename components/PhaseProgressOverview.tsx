      ...
      <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700">
        ...
        <div className="rounded-xl border border-cyan-500/20 bg-cyan-500/5 p-4 mb-6">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <div className="text-sm font-semibold text-cyan-100">Question practice</div>
              <div className="text-sm text-gray-300">
            ...
            <div className="text-sm text-gray-300">
              {lessonOverall.next?.nextIncomplete
                ...
                : "Open a phase to start course checkpoint practice."}
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <div className="text-sm font-semibold text-emerald-200">API Foundations · Free</div>
