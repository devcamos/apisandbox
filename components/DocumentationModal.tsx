          ...
          {documentation.corePrinciples && (
            <section className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20 rounded-xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                {documentation.demoLink && (
                  <a
                    href={documentation.demoLink}
                    className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg text-sm font-semibold transition-all hover:scale-105"
                  >
                    🎮 View Demo
                  </a>
                )}
