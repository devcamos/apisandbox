...
import { useRef, useEffect, useState, useCallback, type MutableRefObject, type RefObject } from "react"
...
function GsapToolbar(props: Readonly<{
  meta: (typeof algorithmMeta)[SearchAlgorithm]
  algorithm: SearchAlgorithm
  target: number
  arr: number[]
...
function GsapStatsRow(props: Readonly<{
  current: SearchState
  algorithm: SearchAlgorithm
...
function GsapGridSection(props: Readonly<{
  arr: number[]
  algorithm: SearchAlgorithm
...
function GsapTransport(props: Readonly<{
  onReset: () => void
  onStep: () => void
  onTogglePlay: () => void
  isPlaying: boolean
...
function GsapNarration(props: Readonly<{
  current: SearchState | null
  stepIdx: number
  stepsLength: number
  meta: (typeof algorithmMeta)[SearchAlgorithm]
...
function GsapTerminalSummary(props: Readonly<{
